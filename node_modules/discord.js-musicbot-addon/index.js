    ...
    class Music {
      constructor(client, options) {
        ...
        this.play = {
          ...
          help: (options && options.play && options.play.help) || "Включить музыку",
        ...
        this.help = {
          ...
          help: (options && options.help && options.help.help) || "Помощь по командам",
        ...
        this.pause = {
          ...
          help: (options && options.pause && options.pause.help) || "Поставить музыку на паузу",
        ...
        this.resume = {
          ...
          help: (options && options.resume && options.resume.help) || "Выключить паузу",
        ...
        this.leave = {
          ...
          help: (options && options.leave && options.leave.help) || "Остановить музыку и покинуть голосовой канал",
        ...
        this.queue = {
          ...
          help: (options && options.queue && options.queue.help) || "Просмотр очередь",
        ...
        this.np = {
          ...
          help: (options && options.np && options.np.help) || "Посмотр информации о том, что сейчас играет",
        ...
        this.loop = {
          ...
          help: (options && options.loop && options.loop.help) || "Включить/выключить повтор",
        ...
        this.search = {
          ...
          help: (options && options.search && options.search.help) || "Расширенный поиск музыки",
        ...
        this.clearqueue = {
          ...
          help: (options && options.clear && options.clear.help) || "Очистить очередь и остановить музыку",
        ...
        this.volume = {
          ...
          help: (options && options.volume && options.volume.help) || "Управление громкостью",
        ...
        this.remove = {
          ...
          help: (options && options.remove && options.remove.help) || "Удалить позицию из очереди",
        ...
        this.skip = {
          ...
          help: (options && options.skip && options.skip.help) || "Включить следующую музыку в очереди",
        ...
        this.shuffle = {
            ...
            help: (options && options.shuffle && options.shuffle.help) || "Перемешать очередь",
        ...
        this.deleteQueue = {
            ...
            help: (options && options.deleteQueue && options.deleteQueue.help) || "Удалить и перестроить очередь",
